...
(deftest make-rat-2-test
  ...
  (is (= "1/2" (b/print-rat (make-rat-2 2 4))))
  (is (= "-1/2" (b/print-rat (make-rat-2 2 -4))))
  (is (= "-1/2" (b/print-rat (make-rat-2 -2 4))))
  (is (= "1/2" (b/print-rat (make-rat-2 -2 -4)))))
...
(deftest mul-rat-test
  (is (= [1 4] (b/mul-rat pos pos)))
  (is (= [-1 4] (b/mul-rat neg pos)))
  (is (= [-1 4] (b/mul-rat pos neg)))
  (is (= [1 4] (b/mul-rat neg neg)))

  (is (= [1 4] (b/mul-rat pos-x2 pos-x2)))
  (is (= [-1 4] (b/mul-rat neg-x2 pos-x2)))
  (is (= [-1 4] (b/mul-rat pos-x2 neg-x2)))
  (is (= [1 4] (b/mul-rat neg-x2 neg-x2))))
